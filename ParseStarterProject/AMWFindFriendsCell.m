...
@implementation AMWFindFriendsCell
@synthesize delegate;
@synthesize user;
...
- (void)setUser:(PFUser *)aUser {
    ...
    CGSize nameSize = [nameString boundingRectWithSize:CGSizeMake(144.0f, CGFLOAT_MAX)
                                            ...
                                            attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:16.0f]}
                                               context:nil].size;
    [nameButton setTitle:[self.user objectForKey:kAMWUserDisplayNameKey] forState:UIControlStateNormal];
    [nameButton setTitle:[self.user objectForKey:kAMWUserDisplayNameKey] forState:UIControlStateHighlighted];
