...
- (void)viewDidLoad {
    ...
    PFQuery *queryFollowerCount = [PFQuery queryWithClassName: kAMWActivityClassKey];
    [queryFollowerCount whereKey:kAMWActivityTypeKey equalTo: kAMWActivityTypeFollow];
    [queryFollowerCount whereKey:kAMWActivityToUserKey equalTo: self.user];
